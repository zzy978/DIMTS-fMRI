...
#SBATCH --gres=gpu:1
#SBATCH --job-name=DFCGraph_MMDenhanced_seq256_pred
#SBATCH --ntasks=1
...
## 调试信息，记得删掉
echo "Check data root on node: $(hostname)"
ls -ld /data/home/zyzeng/data1
ls -ld /data/home/zyzeng/data1/datasets
ls -ld /data/home/zyzeng/data1/datasets/hcp_2400time_csv
